...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mt-6 sm:mt-8 md:mt-[54px] justify-items-center 2xl:max-w-7xl 2xl:mx-auto">
  {foods.map((food) => (
